...
public class PersonServiceImplSoapBindingStub extends org.apache.axis.client.Stub implements com.med.PersonServiceImpl {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnQName(new javax.xml.namespace.QName("", "deletePersonReturn"));
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "id"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"), int.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://med.com", "Person"));
        oper.setReturnClass(com.med.Person.class);
        ...
        oper.setReturnType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        oper.setReturnClass(java.lang.String.class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "updatePersonReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[2] = oper;

        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("getPersons");
        oper.setReturnType(new javax.xml.namespace.QName("http://med.com", "ArrayOf_xsd_anyType"));
        oper.setReturnClass(java.lang.Object[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "getPersonsReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        _operations[3] = oper;
    ...
    public PersonServiceImplSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://med.com", "ArrayOf_xsd_anyType");
            ...
            qName = new javax.xml.namespace.QName("http://med.com", "Person");
            cachedSerQNames.add(qName);
            cls = com.med.Person.class;
            cachedSerClasses.add(cls);
    ...
    public java.lang.String deletePerson(int id) throws java.rmi.RemoteException {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://med.com", "deletePerson"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Integer(id)});
  ...
  throw axisFaultException;
    ...
    public com.med.Person getPerson(int id) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://med.com", "getPerson"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Integer(id)});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (com.med.Person) _resp;
            } catch (java.lang.Exception _exception) {
                return (com.med.Person) org.apache.axis.utils.JavaUtils.convert(_resp, com.med.Person.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
    ...
    public java.lang.String updatePerson(int id, java.lang.String name, int age) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://med.com", "updatePerson"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Integer(id), name, new java.lang.Integer(age)});
  ...
  throw axisFaultException;
    ...
    public java.lang.Object[] getPersons() throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://med.com", "getPersons"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {});
  ...
  throw axisFaultException;
    ...
    public java.lang.String createPerson(int id, java.lang.String name, int age) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://med.com", "createPerson"));
