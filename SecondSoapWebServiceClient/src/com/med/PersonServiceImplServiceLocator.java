...
public class PersonServiceImplServiceLocator extends org.apache.axis.client.Service implements com.med.PersonServiceImplService {
    ...
    private java.lang.String PersonServiceImpl_address = "http://localhost:8080/SecondSoapWebService/services/PersonServiceImpl";
    ...
    public com.med.PersonServiceImpl getPersonServiceImpl() throws javax.xml.rpc.ServiceException {
    ...
    public com.med.PersonServiceImpl getPersonServiceImpl(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.med.PersonServiceImplSoapBindingStub _stub = new com.med.PersonServiceImplSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.med.PersonServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                com.med.PersonServiceImplSoapBindingStub _stub = new com.med.PersonServiceImplSoapBindingStub(new java.net.URL(PersonServiceImpl_address), this);
                _stub.setPortName(getPersonServiceImplWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://med.com", "PersonServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://med.com", "PersonServiceImpl"));
        }
