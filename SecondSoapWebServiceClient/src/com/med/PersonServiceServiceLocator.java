...
public class PersonServiceServiceLocator extends org.apache.axis.client.Service implements com.med.PersonServiceService {
    ...
    private java.lang.String PersonService_address = "http://localhost:8080/SecondSoapWebService/services/PersonService";
    ...
    public com.med.PersonService getPersonService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.med.PersonServiceSoapBindingStub _stub = new com.med.PersonServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.med.PersonService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.med.PersonServiceSoapBindingStub _stub = new com.med.PersonServiceSoapBindingStub(new java.net.URL(PersonService_address), this);
                _stub.setPortName(getPersonServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://med.com", "PersonServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://med.com", "PersonService"));
        }
